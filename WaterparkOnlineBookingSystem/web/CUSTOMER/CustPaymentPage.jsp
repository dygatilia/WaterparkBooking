<%-- 
    Document   : CustPaymentPage
    Created on : Apr 4, 2022, 5:14:51 AM
    Author     : Hp
--%>
                        ...
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300 border-0">
                                ...
                                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                                    <form>
                                        <div class="relative w-1/3 mb-3">
                                            <label class="block uppercase text-gray-700 text-xs font-bold mb-2" for="paymenttype">Payment Type</label>
                                            <select id="paymenttype" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        ...
                                        <div class="relative mt-6">
                                            <table class="items-left">
                                                <tr>
                                                    ...
                                                    <td class="py-2 px-28">
                                                        <label class="block uppercase text-gray-700 text-xs font-bold" for="grid-password">RM 50.00</label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="btn-wrapper text-center mt-6">
                                            <button class="bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-2 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="button" style="transition: all 0.15s ease 0s;">
                                                <a href="CustConfirmBook.jsp"> BACK </a>
                                            </button>
                                            <button class="bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="button" style="transition: all 0.15s ease 0s;">
                                                <a href="CustPaymentResult.jsp"> PAY </a>
                                            </button>
                                        </div>
                                    </form>
                                </div>
