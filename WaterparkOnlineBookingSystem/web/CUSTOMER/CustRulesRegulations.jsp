<%-- 
    Document   : CustRulesRegulations
    Created on : Mar 28, 2022, 12:25:41 AM
    Author     : Hp
--%>
                ...
                <div class="container mx-auto px-4 lg:pt-24">
                    <div class="flex flex-wrap text-center justify-center">
                        <div class="w-full lg:w-6/12 px-4">
                            <h2 class="text-3xl font-semibold text-white">Rules & Regulations</h2>
                        </div>
                    </div>
                </div>
            </section>
            <div class="relative bg-gray-900 mt-3 px-4 sm:px-6 lg:px-10">
                <div class="text-justify mt-3">
                    <div class="items-center flex-1 flex flex-col justify-center pt-16 lg:pt-16 lg:pb-8">
                        <div class="bg-white px-6 py-8 w-2/4 rounded shadow-md text-black">
                            <p>
                                1. All visitors are to be FULLY VACCINATED, Child below the age of 18 years old are not vaccinated are to be accompanied by fully vaccinated parents.
                            </p>
                            <br>
                            <p>
                                2. All visitors are required to obey dress code displayed at the pools and water slides.
                            </p>
                            <br>
                            <p>
                                3. Please obey all instruction given by lifeguards / attendants or any authorized personnel for your own safety.
                            </p>
                            <br>
                            <p>
                                4. Bather must shower before entering the pools & water slides.
                            </p>
                            <br>
                            <p>
                                5. No person suffering from any infection or contagious disease may use the pools and water sliders.
                            </p>
                            <br>
                            <p>
                                6. No person who are offensively unclean or under the influence of liquor or tranquilizing drugs may use the pools and water slides.
                            </p>
                        </div>
                    </div>
                </div>
