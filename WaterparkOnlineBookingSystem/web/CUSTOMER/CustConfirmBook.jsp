<%-- 
    Document   : CustConfirmBook
    Created on : Apr 4, 2022, 3:25:08 AM
    Author     : Hp
--%>
                                    ...
                                    <form>
                                        <div class="relative w-1/4 mb-3">
                                            <table class="items-left">
                                                <tr>
                                                    <td class="py-2 pr-8">
                                                        <label class="block uppercase text-gray-700 text-xs font-bold" for="grid-password">Date</label>
                                                    </td>
                                                    <td class="px-14">
                                                        <div class="flex justify-center">
                                                            <div class="xl:w-24">
                                                                <input type="text" id="exampleFormControlInput5" value="24/12/2022" aria-label="readonly input example" readonly
                                        ...
                                        <div class="relative w-full mb-3">
                                            <table class="items-left">
                                                <tr>
                                                    <td class="py-2 pr-8">
                                                        <label class="block uppercase text-gray-700 text-xs font-bold" for="grid-password">Full Name</label>
                                                    </td>
                                                    <td class="py-2 px-4">
                                                        <div class="flex justify-center">
                                                            <div class="xl:w-96">
                                                                <input type="text" id="exampleFormControlInput5" value="Dayang Farhanim Atilia Binti Mohd Azaman" aria-label="readonly input example" readonly
                                                                       class=" form-control block w-full uppercase px-3 py-1.5 text-xs font-bold text-gray-700 bg-gray-100 bg-clip-padding border 
                                                                       border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 
                                                                       focus:outline-none"/>
                                                            </div>
                                        ...
                                        <div class="relative w-1/6 mt-5">
                                            <label class="block uppercase text-gray-700 text-xs font-bold" for="grid-password">Ticket Type</label>
                                        </div>
                                        <div class="relative mb-3">
                                            <table class="items-left">
                                                <tr>
                                                    <td class="py-2 pr-8">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">Adult</label>
                                                    </td>
                                                    <td class="py-2 px-10">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">RM 15.00</label>
                                                    </td>
                                                    <td class="py-2">
                                                        <div class="flex justify-center">
                                                            <div class="xl:w-12">
                                                                <input type="text" id="exampleFormControlInput5" value="1" aria-label="readonly input example" readonly
                                                                       class=" form-control block w-full uppercase px-3 py-1.5 text-xs text-center font-bold text-gray-700 bg-gray-100 bg-clip-padding border 
                                                                       border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 
                                                                       focus:outline-none"/>
                                                            </div>
                                                        </div>
                                                ...
                                                <tr>
                                                    <td class="py-2 pr-8">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">Child</label>
                                                    </td>
                                                    <td class="py-2 px-10">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">RM 12.00</label>
                                                    </td>
                                                    <td class="py-2">
                                                        <div class="xl:w-12">
                                                            <input type="text" id="exampleFormControlInput5" value="1" aria-label="readonly input example" readonly
                                                ...
                                                <tr>
                                                    <td class="py-2 pr-8">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">Senior</label>
                                                    </td>
                                                    <td class="py-2 px-10">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">RM 8.00</label>
                                                    </td>
                                                    <td class="py-2">
                                                        <div class="xl:w-12">
                                                            <input type="text" id="exampleFormControlInput5" value="1" aria-label="readonly input example" readonly
                                        ...
                                        <div class="relative w-1/6 mt-3">
                                            <label class="block uppercase text-gray-700 text-xs font-bold" for="grid-password">Facilities</label>
                                        </div>
                                        <div class="relative mb-3">
                                            <table class="items-left">
                                                <tr>
                                                    <td class="py-2">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">Double Tube</label>
                                                    </td>
                                                    <td class="py-2 px-5">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">RM 13.00</label>
                                                    </td>
                                                    <td class="py-2 px-5">
                                                        <div class="xl:w-12">
                                                            <input type="text" id="exampleFormControlInput5" value="1" aria-label="readonly input example" readonly
                                                ...
                                                <tr>
                                                    <td class="py-2">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">Single Tube</label>
                                                    </td>
                                                    <td class="py-2 px-5">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">RM 10.00</label>
                                                    </td>
                                                    <td class="py-2 px-5">
                                                        <div class="xl:w-12">
                                                            <input type="text" id="exampleFormControlInput5" value="1" aria-label="readonly input example" readonly
                                                ...
                                                <tr>
                                                    <td class="py-2">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">Children Tube</label>
                                                    </td>
                                                    <td class="py-2 px-5">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">RM 6.00</label>
                                                    </td>
                                                    <td class="py-2 px-5">
                                                        <div class="xl:w-12">
                                                            <input type="text" id="exampleFormControlInput5" value="1" aria-label="readonly input example" readonly
                                                ...
                                                <tr>
                                                    <td class="py-2">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">Locker</label>
                                                    </td>
                                                    <td class="py-2 px-5">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">RM 10.00</label>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="py-2">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">Gazebo</label>
                                                    </td>
                                                    <td class="py-2 px-5">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">RM 40.00</label>
                                                    </td>
                                                    <td class="py-2 px-5">
                                                        <div class="xl:w-12">
                                                            <input type="text" id="exampleFormControlInput5" value="1" aria-label="readonly input example" readonly
                                                ...
                                                <tr>
                                                    <td class="py-2">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">Hobbit House</label>
                                                    </td>
                                                    <td class="py-2 px-5">
                                                        <label class="block uppercase text-gray-700 text-xs font-medium" for="grid-password">RM 65.00</label>
                                                    </td>
                                                    <td class="py-2 px-5">
                                                        <div class="xl:w-12">
                                                            <input type="text" id="exampleFormControlInput5" value="1" aria-label="readonly input example" readonly
                                        ...
                                        <div class="relative">
                                            <table class="items-left">
                                                <tr>
                                                    <td class="py-2 pr-8">
                                                        <label class="block uppercase text-gray-700 text-xs font-bold" for="grid-password">Promo Code</label>
                                                    </td>
                                                    <td class="py-2">
                                                        <div class="xl:w-36">
                                                            <input type="text" id="exampleFormControlInput5" value="MYNEW10" aria-label="readonly input example" readonly
                                                                   class=" form-control block w-full uppercase px-3 py-1.5 text-xs text-center font-bold text-gray-700 bg-gray-100 bg-clip-padding border 
                                                                   border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 
                                                                   focus:outline-none"/>
                                                        </div>
                                        ...
                                        <div class="relative mt-3">
                                            <table class="items-left">
                                                <tr>
                                                    <td class="py-2 pr-8">
                                                        <label class="block uppercase text-gray-700 text-xs font-bold" for="grid-password">Total</label>
                                                    </td>
                                                    <td class="py-2 px-11">
                                                        <div class="xl:w-36">
                                                            <input type="text" id="exampleFormControlInput5" value="RM 50.00" aria-label="readonly input example" readonly
                                                                   class=" form-control block w-full uppercase px-3 py-1.5 text-xs text-center font-bold text-gray-700 bg-gray-100 bg-clip-padding border 
                                                                   border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-gray-50 focus:border-blue-600 
                                                                   focus:outline-none"/>
                                                        </div>
                                                    </td>
                                                </tr>
                                        ...
                                        <div class="btn-wrapper text-center mt-6">
                                            <button class="bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-2 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="button" style="transition: all 0.15s ease 0s;">
                                                <a href="CustBookTicket.jsp"> BACK </a>
                                            </button>
                                            <button class="bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="button" style="transition: all 0.15s ease 0s;">
                                                <a href="CustPaymentPage.jsp"> CONFIRM </a>
                                            </button>
                                        </div>
                                    </form>
                                </div>
