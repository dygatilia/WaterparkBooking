<%-- 
    Document   : CustEditProfile
    Created on : Mar 28, 2022, 5:29:18 AM
    Author     : Hp
--%>
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
                        <div class="px-6">
                            <form action="../UserController">
                                    ...
                                    <div class="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                                        <div class="py-6 px-3 mt-32 sm:mt-0">
                                            <button class="bg-blue-500 active:bg-blue-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1"
                                                    type="submit" name="command" value="updateUser" style="transition: all 0.15s ease 0s;">
                                               UPDATE
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-6 py-3 border-gray-300 text-left items-center">
                                    <div>
                                    ...
                                    <table class="mx-auto">
                                        <tr>
                                            ...
                                            <td class="py-2">
                                                <label class="mr-4"><b>Name: </b></label>
                                            </td>
                                            <td class="py-2">
                                                <input class="px-4 w-full border rounded" type="text" name="name" size="30" value="<%=user.getName()%>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="py-2">
                                            ...
                                            <td class="py-2">
                                                <div>
                                                    <input type="email" name="email" id="exampleFormControlInput5" value="<%=user.getEmail()%>" aria-label="readonly input example" readonly
                                                           class="form-control block w-full px-4 text-l text-gray-900 bg-white bg-clip-padding border 
                                                           rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 
                                                           focus:outline-none " data-bs-toggle="tooltip" title="Email cannot be modified."/>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="py-2">
                                                <label class="mr-4"><b>Password: </b></label>
                                            </td>
                                            <td class="w-4/5 py-2">
                                                <input class="px-4 w-full border rounded" type="text" name="password" size="30" value="<%=user.getPassword()%>">
                                            </td>
                                        </tr>
                                    </table>
                                </div>
