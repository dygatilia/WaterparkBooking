<%-- 
    Document   : CustFacilities
    Created on : Mar 28, 2022, 12:24:49 AM
    Author     : Hp
--%>
                ...
                <div class="container mx-auto px-4">
                    <div class="flex flex-wrap justify-center text-center mb-24">
                        <div class="w-full lg:w-6/12 px-4">
                            <h2 class="text-3xl font-semibold text-white">Facilities</h2>
                            <p class="text-lg leading-relaxed m-4 text-white-600"></p>
                        </div>
                    </div>
                    <div class="flex flex-wrap">
                        <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <div class="px-6">
                                <img alt="..." src="https://thumbs.dreamstime.com/b/locker-icon-change-room-simple-illustration-outline-style-sport-symbol-locker-icon-change-room-simple-illustration-outline-style-123295437.jpg"
                                     class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 120px;"/>
                                <div class="pt-6 text-center">
                                    <h5 class="text-xl text-white font-bold">Locker Rental</h5>
                                    <p class="mt-1 text-sm text-gray-500 uppercase font-semibold"></p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <div class="px-6">
                                <img alt="..." src="https://cdn1.iconfinder.com/data/icons/wedding-cool-vector-2/128/97-512.png"
                                     class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 120px;"/>
                                <div class="pt-6 text-center">
                                    <h5 class="text-xl text-white font-bold">Cabana Rental</h5>
                                    <p class="mt-1 text-sm text-gray-500 uppercase font-semibold"></p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <div class="px-6">
                                <img alt="..." src="https://cdn3.iconfinder.com/data/icons/summer-189/64/3_life_tube_safety-512.png"
                                     class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 120px;"/>
                                <div class="pt-6 text-center">
                                    <h5 class="text-xl text-white font-bold">Tube Rental</h5>
                                    <p class="mt-1 text-sm text-gray-500 uppercase font-semibold"></p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <div class="px-6">
                                <img alt="..." src="https://fsea-consulting.com/wp-content/uploads/2019/03/Home-icon.png"
                                     class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 120px;"/>
                                <div class="pt-6 text-center">
                                    <h5 class="text-xl text-white font-bold">Other Facilities</h5>
                                    <p class="mt-1 text-sm text-gray-500 uppercase font-semibold"></p>
                                </div>
                            </div>
                        </div>
