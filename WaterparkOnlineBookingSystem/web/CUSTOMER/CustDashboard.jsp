<%-- 
    ...
    Created on : Mar 28, 2022, 12:27:14 AM
    Author     : Hp
--%>
            ...
            <section class="relative py-16 bg-gray-300">
                <div class="container mx-auto px-4">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
                        <div class="px-20">
                            <div class="flex flex-wrap text-left text-xl mt-12">
                                <i class="fa fa-list mr-2 text-xl ml-40"></i>
                                <h3 class="text-xl font-bold">BOOKED LIST</h3>
                            </div>
                            <div class="flex flex-wrap text-left text-sm mt-12">
                                <p class="w-24 ml-40 font-semibold">NO</p>
                                <p class="w-32 font-semibold">DATE</p>
                                <p class="w-40 font-semibold">BOOKING ID</p>
                                <p class="w-40 font-semibold">BOOKING STATUS</p>
                            </div>
                            <div class="flex flex-wrap text-left text-sm pt-6">
                                <p class="w-24 ml-40">1</p>
                                <p class="w-32">24/12/2022</p>
                                <p class="w-40">1</p>
                                <p class="w-40">Pending</p>
                                <p class="w-40"></p><p class="w-36"></p>
                                <button class="text-lg items-center justify-center align-center mr-3" type="button">
                                    <i class="fa fa-download"></i>
                                </button>
                                <button class="bg-blue-500 active:bg-blue-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 rounded outline-none focus:outline-none sm:mr-2 mb-1"
                                        type="button" style="transition: all 0.15s ease 0s;">
                                    <a href="CustEditProfile.jsp"> EDIT </a>
                                </button>
                                <button class="bg-red-500 active:bg-blue-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-2 rounded outline-none focus:outline-none sm:mr-2 mb-1"
                                        type="button" style="transition: all 0.15s ease 0s;">
                                    <a href="CustEditProfile.jsp"> CANCEL </a>
                                </button>
                            </div>
                            <div class="flex flex-wrap text-left text-sm pt-6">
                                <p class="w-24 ml-40">2</p>
                                <p class="w-32">12/03/2022</p>
                                <p class="w-40">2</p>
                                <p class="w-40">Pending</p>
                                <p class="w-40"></p><p class="w-36"></p>
                                <button class="text-lg items-center justify-center align-center mr-3" type="button">
                        ...
                        <div class="flex flex-wrap items-top mb-6">
                            <div class="w-full lg:w-4/12 px-4 ml-auto">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <a class="text-black font-semibold block pb-2 text-sm" href="CustFeatures.jsp">Features</a>
                                    </li>
                                    <li>
                                        <a class="text-black font-semibold block pb-2 text-sm" href="CustFacilities.jsp">Facilities</a>
                                    </li>
                                    <li>
                                        <a class="text-black font-semibold block pb-2 text-sm" href="CustPromotions.jsp">Promotions</a>
                                    </li>
                                </ul>
                            </div>
