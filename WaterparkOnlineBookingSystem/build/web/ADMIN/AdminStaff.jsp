                            ...
                            <tr>
                                ...
                                <td class="actions-cell">
                                    <div class="buttons right nowrap">
                                        <a href="StaffDetails.jsp?id=<%=staf.getStaffID()%>" class="button small green">
                                            <span class="icon"><i class="mdi mdi-pencil"></i></span>
                                        </a>
                                        <form action="<%=request.getContextPath()%>/StaffController" method="POST">
                                            <input type="hidden" name="id" value="<%=staf.getStaffID()%>">
                                            <button type="submit" name="command" value="delete" class="button small red">
