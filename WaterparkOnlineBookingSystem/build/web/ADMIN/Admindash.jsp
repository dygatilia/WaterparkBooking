                ...
                <div class="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
                    ...
                    <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                        <li class="items-center">
                                <a class="text-blue-400 hover:text-blue-600 text-xs uppercase py-3 font-bold block" href="AdminDashboard.jsp">
                            ...
                            <li class="items-center">
                                <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block" href="AdminSettings.jsp">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="border-t-0 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap">
                                                    <i class="fas fa-arrow-down text-emerald-500 mr-4"></i>
                                                </td>
                                                <td class="border-t-0 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap">
