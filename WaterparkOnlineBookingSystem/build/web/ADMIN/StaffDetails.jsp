...
<html lang="en" class="">
    <head>
        ...
        <title>Staff Details || Admin</title>
            ...
            <section class="section main-section">
                <div class="card mb-6">
                    ...
                    <%
                        ...
                        Staff staff = staffdao.retrieveStaffByStaffId(Integer.parseInt(staffid));
                    %>
                    <div class="card-content">
                        <form action="../StaffController" method="POST">
                                ...
                                <div class="field-body">
                                    <div class="field">
                                        ...
                                        <div class="control icons-left">
                                            <input class="input" name=name type="text" placeholder="Name" value="<%=staff.getStaffName()%>">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left icons-right">
                                            <input class="input" name="email" type="email" placeholder="Email" value="<%=staff.getStaffEmail()%>">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control icons-left icons-right">
                                            <input class="input" name="password" type="password" placeholder="Password" value="<%=staff.getStaffPassword()%>">
                            ...
                            <div class="field grouped">
                                ...
                                <div class="control">
                                    <button type="submit" name="command" value="update" class="button green">
                                        Update
                                    </button>
                                </div>
                                <div class="control">
                                    <button type="submit" name="command"  value="delete" class="button red">
                                        Delete
                                    </button>
                                </div>
                            </div>
