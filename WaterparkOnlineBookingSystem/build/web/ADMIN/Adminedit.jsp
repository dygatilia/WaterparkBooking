        ...
        <div id="root">
            <nav class="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6">
                <div class="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
                    ...
                    <a class="md:block text-left md:pb-2 text-blueGray-600 mr-0 inline-block whitespace-nowrap text-s uppercase font-bold p-4 px-0" href="javascript:void(0)">
                        ADMIN
                    </a>
                    ...
                    <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden"
                        ...
                        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                            <li class="items-center">
                                <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block" href="AdminDashboard.jsp">
                                    <i class="fas fa-list opacity-75 mr-2 text-sm"></i>
                                    Dashboard
                                </a>
                            </li>
                            <li class="items-center">
                            ...
                            <li class="items-center">
                                <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block" href="#">
                                    <i class="fas fa-building text-blueGray-400 mr-2 text-sm"></i>
                                    Facilities
                                </a>
                            </li>
                            <li class="items-center">
                                <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block" href="#" >
                                    <i class="fas fa-inbox text-blueGray-400 mr-2 text-sm"></i>
                                    Messages
                                </a>
                            </li>
                            <li class="items-center">
                            ...
                            <li class="items-center">
                                <a class="text-blue-400 hover:text-blue-600 text-xs uppercase py-3 font-bold block" href="AdminSettings.jsp">
                                    <i class="fas fa-cog text-blueGray-400 mr-2 text-sm"></i>
                                    Settings
                                </a>
                            </li>
                        </ul>
            ...
            <div class="relative md:ml-64 bg-blueGray-50">
                ...
                <div class="px-4 md:px-10 mx-auto w-full -m-24">
                    <div class="flex flex-wrap mt-4">
                        <div class="w-1/2 mb-12 xl:mb-0 px-4 justify-center">
                            <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
                                <form class="pl-10 pt-5 pb-10 bg-white rounded shadow-xl" action="../UserController">
                                    <div class="rounded-t mb-0 py-3 border-0">
                                        <div class="flex flex-wrap items-center">
                                            <div class="relative w-full mt-2 max-w-full flex-grow flex-1">
                                    ...
                                    %>
                                    <div class="block w-full mb-2 overflow-x-auto">
                                        <div>
                                            <div>
                                        ...
                                        <div>
                                            <div>
                                                <label class="mt-4 block text-s text-gray-900" for="email"><b>Email:</b>
                                                    <i class="fa fa-info-circle w-2 h-2 text-blue-600 hover:text-blue-700 transition duration-150 ease-in-out mb-2" 
                                                   data-bs-toggle="tooltip" title="Email cannot be modified."></i>
                                                </label>
                                                <input class="px-1 w-5/6 border rounded" aria-label="readonly input example" readonly data-bs-toggle="tooltip" title="Email cannot be modified."
                                                       type="email" name="email" size="30" value="<%=admin.getAdEmail()%>">
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                <label class="mt-4 block text-s text-gray-900" for="password"><b>Password:</b></label>
                                                <input class="px-1 w-5/6 border rounded" type="text" name="password" size="30" value="<%=admin.getAdPassword()%>">
                                            </div>
                                        </div>
                                        <br>
                                    </div>
