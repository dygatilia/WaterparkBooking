                            ...
                            <div class="relative flex flex-col min-w-0 break-words bg-white mb-6 shadow-lg rounded">
                                ...
                                %>
                                    <div class="flex flex-wrap items-center">
                                        <div class="relative w-full px-2 mt-2 max-w-full flex-grow flex-1">
                                        ...
                                        <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                                            <button class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1"
                                                ...
                                                <a href="AdminEditProfile.jsp">EDIT</a>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Projects table -->
                                <table class="items-center bg-transparent mb-2 border-collapse">
                                    <tbody>
                                        <tr>
                                            <th class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-s whitespace-nowrap p-4 text-left">
                                                Email:
                                            </th>
