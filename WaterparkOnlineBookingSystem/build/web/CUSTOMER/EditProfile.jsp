                    ...
                    <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden"
                        ...
                        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                            <li class="items-center">
                                <button class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-8 py-1 rounded outline-none focus:outline-none mr-1 mb-1"
                            ...
                            <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
                                <form class="pl-10 pt-5 pb-10 bg-white rounded shadow-xl" action="../UserController">
                                    ...
                                    <div class="block w-full overflow-x-auto">
                                        ...
                                        <div>
                                            <div>
                                                <label class="mt-4 block text-xs text-gray-900" for="name"><b>Full Name:</b></label>
                                                <input class="px-1 w-5/6 border rounded" type="text" name="name" size="30" value="<%=user.getName()%>">
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                <label class="mt-4 block text-xs text-gray-900" for="email"><b>Email:</b></label>
                                                <input class="px-1 w-5/6 border rounded" type="email" name="email" size="30" value="<%=user.getEmail()%>">
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                <label class="mt-4 block text-xs text-gray-900" for="password"><b>Password:</b></label>
                                                <input class="px-1 w-5/6 border rounded" type="text" name="password" size="30" value="<%=user.getPassword()%>">
                                            </div>
                                        </div>
                                        <br>
                                    </div>
