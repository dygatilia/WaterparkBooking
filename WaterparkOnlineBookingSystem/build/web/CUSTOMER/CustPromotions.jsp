<%-- 
    Document   : CustPromotions
    Created on : Mar 28, 2022, 12:25:31 AM
    Author     : Hp
--%>
            ...
            <div class="container mx-auto px-4 lg:pt-24">
                <div class="flex flex-wrap text-center justify-center">
                    <div class="w-full lg:w-6/12 px-4">
                        <h2 class="text-3xl font-semibold text-white">Promotions</h2>
                    </div>
                </div>
            </div>
            <div class="relative bg-gray-900 mt-3 px-4 sm:px-6 lg:px-10 pb-14 lg:pb-20 xl:pb-28">
                <div class="text-justify mt-3">
                    <div class="items-center flex-1 flex flex-col justify-center pt-16 lg:pt-16 lg:pb-8">
                        <img src="https://media.karousell.com/media/photos/products/2021/4/7/waterpark_desaru_promo_rm50_un_1617758955_6a30981e" alt="Promo1" style="width:30%">
                        <br>
                        <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/324362491.jpg?k=58352df65f9ef0136030c818cc0d162c32df98a883b4e43490cd0bb013b36108&o=&hp=1" alt="Promo1" style="width:30%">
                    </div>
                </div>
            </div>
        </div>
