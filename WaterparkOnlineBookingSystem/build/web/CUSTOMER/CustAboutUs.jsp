<%-- 
    Document   : CustAboutUs
    Created on : Mar 28, 2022, 12:23:33 AM
    Author     : Hp
--%>
                ...
                <div class="text-justify mt-3">
                    <div class="items-center flex-1 flex flex-col justify-center pt-16 lg:pt-16 lg:pb-8">
                        <div class="bg-white px-6 py-8 w-2/4 rounded shadow-md text-black">
                            <p>Jengka Wonderland, the first water park to be set up within a Felda region, officially opened its doors on Dec 1.</p>
                            <br>
                            <p>Although it may not be as popular as other premier water parks in the country, Jengka Wonderland in Bandar Pusat Jengka near here, 
                                offers a good time for both children and adults especially Felda settlers and those from neighbouring districts.</p>
                            <br>
                            <p>Nestled among lush greenery, the 1.2ha water park, which adopts a Middle Eastern architectural concept, offers various attractions 
                                ranging from adults and children’s water slides, a slide tower with five slides, pirate-ship, a man-made wave beach and sprouting water cannons.</p>
                        </div>
                    </div>
                </div>
            </div><br><br><br><br>
