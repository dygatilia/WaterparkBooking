<%-- 
    Document   : CustBookTicket
    Created on : Apr 1, 2022, 12:24:11 PM
    Author     : Hp
--%>
...
<html>
    <head>
        ...
        <title>Customer Book Ticket</title>
                                ...
                                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                                    <form>
                                        <div class="relative w-1/4 mb-3">
                                            <label class="block uppercase text-gray-700 text-xs font-bold mb-2" for="grid-password">Date</label>
                                            <div class="flex absolute inset-y-0 left-0 mt-6 items-center pl-3 pointer-events-none">
                                        ...
                                        <div class="relative w-full mb-3">
                                            <label class="block uppercase text-gray-700 text-xs font-bold mb-2" for="grid-password">Full Name</label>
                                            <input type="text" class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded-lg text-sm shadow focus:outline-none focus:ring w-full"
                                        ...
                                        <div class="relative mb-3">
                                            <table class="items-left">
                                                <tr>
                                                    ...
                                                    <td class="py-2">
                                                        <input type="number" class="form-control w-1/3 px-3 py-2 text-sm text-gray-700 bg-white bg-clip-padding border-0 rounded-lg shadow transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                                               id="exampleNumber0" placeholder="Num"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="py-2 pr-8">
                                        ...
                                        <div class="relative w-2/5 mb-3">
                                            <label class="block uppercase text-gray-700 text-xs font-bold mb-2" for="grid-password">Promo Code</label>
                                            <input type="text" class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded-lg text-sm shadow focus:outline-none focus:ring w-full"
                                                   placeholder="Promo Code" style="transition: all 0.15s ease 0s;"/>
                                        </div>
                                        <div class="btn-wrapper text-center mt-6">
                                            <button class="bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-2 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="button" style="transition: all 0.15s ease 0s;">
                                                <a href="CustDashboard.jsp"> CANCEL </a>
                                            </button>
                                            <button class="bg-gray-800 active:bg-blue-100 text-white font-bold px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs"
                                                    type="button" style="transition: all 0.15s ease 0s;">
                                                <a href="CustConfirmBook.jsp"> BOOK </a>
                                            </button>
                                        </div>
                                    </form>
                                </div>
